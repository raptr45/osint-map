      ...
      <header className="sticky top-0 w-full p-4 flex justify-between items-center z-50 bg-background/50 backdrop-blur-xl border-b border-border/50">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="font-bold text-xl tracking-tight hidden sm:block uppercase text-foreground font-display">OSINT MAP</span>
          </div>

          <Suspense fallback={<div className="w-64 h-8 bg-secondary/20 animate-pulse rounded-full" />}>
            <HeaderFilters />
          </Suspense>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center bg-secondary/30 rounded-full px-4 py-1.5 border border-border/50 text-xs font-medium text-muted-foreground mr-2">
             <span className="relative flex h-2 w-2 mr-2">
              ...
              <span className="font-display font-bold uppercase tracking-wide">Real-time Global Sync</span>
          </div>
